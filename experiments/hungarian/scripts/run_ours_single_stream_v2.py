...
print(f"fine-tuned v2 (DPI-corrected) single-stream Hungarian CER: {cer:.5f}")
with open("results/ours_single_stream_v2.json", "w", encoding="utf-8") as f:
    json.dump({"pages": len(refs), "cer": cer, "lang": "hun (fine-tuned v2)", "config": "--psm 3"}, f, indent=2)
