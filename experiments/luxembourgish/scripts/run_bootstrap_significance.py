"""Paired bootstrap CI + permutation test, stock Tesseract ltz vs the 5-stream
LV-ROVER ensemble, on the same 200-line real BnL eval set. Closes the
statistical-rigor gap the peer review flagged (28.5% margin,
no test run)."""
import json
import sys
import unicodedata
